...
const mensajesDeError = {
    ...
    nacimiento: {
        valueMissing: "El campo fecha de nacimiento puede estar vacio",
        customError: "Debes tener al menos 18 anos de edad",
    },
    numero: {
        valueMissing: "El campo telefono no puede estar vacio",
        patternMismatch: "El formato requerido es XXXXXXXXXX numeros"
    },
    direccion: {
...
function validarNacimiento(input){
    ...
    if(mayorDeEdad(fechaCliente)){
        mensaje = "Deberias tener al menos 18 anos de edad";
    }
